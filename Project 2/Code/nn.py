...
class NN(nn.Module):
    def __init__(self, in_channels = 3, hidden_channels = (16, 32), hidden_neurons = (128, 128), num_classes = 10):
        super().__init__()
    ...
    def forward(self, inputs):
        ...
        outputs = self.classifier(hidden.view(-1, self.hidden_channels[1] * 8 * 8))
        return outputs
