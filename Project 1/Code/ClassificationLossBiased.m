function [loss, grad] = ...
    ClassificationLossBiased(weights, X, y, nHidden, nLabel)
    ...
    if nargout > 1
        [gradInput, gradHidden, gradOutput] = ...
            InitializeGrad(weightsInput, weightsHidden, ...
            weightsOutput, nHidden);
    end
    ...
    if nargout > 1
        grad = FormGradBiased(gradInput, gradHidden, gradOutput, ...
