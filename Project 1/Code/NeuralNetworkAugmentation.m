...
for indexTrial = 1:nTrial
    ...
    for iter = 1:iterMax
        ...
        [~, gradLinear] = NNClassificationLoss(weightLinear, ...
            indexTrain, prob(indexTrial, :));
...
legend('without data augmentation', 'with data augmentation');
xlabel('Iteration');
ylabel('Error rate');
title('Validation Set Error Rate with or Without Data Augmentation');