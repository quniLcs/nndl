...
We use pre-trained ResNet-18 as the classifier \citep{ResNet}.
...
In Oracle-FS dataset, all images are gray-scale ones, whose pixel values ranging from 0 to 255. To normalize the data, we get all pixel values minus 127 and be divided by 128
...
\begin{equation*}
	\tilde{O} = 
	(\frac{\Delta x}{49}, \frac{\Delta y}{49}, 
	p_2 + p_3 - \frac{1}{2}) 
\end{equation*} 
